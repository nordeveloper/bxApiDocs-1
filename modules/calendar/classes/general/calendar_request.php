...
//					break;
	...
	public static function EditSection()
	{
		...
		if ($id > 0)
		{
			...
			if (!$oSect)
				return CCalendar::ThrowError(Loc::getMessage('EC_CALENDAR_SAVE_ERROR'));
