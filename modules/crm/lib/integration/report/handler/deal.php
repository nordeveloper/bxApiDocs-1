...
//						{
//							if (!isset($previewsItem['additionalValues']['sum']))
//							{
//								$previewsItem['additionalValues']['sum'] = 0;
//							}
//							$previewsItem['additionalValues']['sum'] += $data['additionalValues']['sum']['VALUE'];
//						}
		...
		$config['valuesAmount'] = [$amountDealSum, $amountDealCount];
