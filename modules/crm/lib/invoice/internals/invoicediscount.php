...
use Bitrix\Crm\Invoice\Internals;
...
class InvoiceDiscountTable extends Main\Entity\DataManager
{
	...
	public static function clearList($discount)
	{
		...
		foreach ($discountRows as &$row)
		{
			...
			InvoiceModulesTable::clearByDiscount($row);
		}
...
class InvoiceCouponsTable extends Main\Entity\DataManager
{
	/**
	 * Returns DB table name for entity.
	 *
	...
	public static function getMap()
	{
		return array(
			...
			'ORDER_DISCOUNT' => new Main\Entity\ReferenceField(
				'ORDER_DISCOUNT',
				'Bitrix\Crm\Invoice\Internals\OrderDiscount',
...
class InvoiceModulesTable extends Main\Entity\DataManager
{
	/**
	 * Returns DB table name for entity.
	 *
...
/**
 * Class InvoiceDiscountDataTable
 *
 * Fields:
 * <ul>
 * <li> ID int mandatory
...
class InvoiceDiscountDataTable extends Main\Entity\DataManager
{
	...
	public static function getTableName()
	{
		return 'b_crm_invoice_discount_data';
	}
...
class InvoiceRulesDescrTable extends Main\Entity\DataManager
{
	...
	public static function getTableName()
	{
		return 'b_crm_invoice_rules_descr';
	}
