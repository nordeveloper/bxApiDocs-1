...
class Lead extends Crm\Volume\Base implements Crm\Volume\IVolumeClear, Crm\Volume\IVolumeClearActivity, Crm\Volume\IVolumeClearEvent, Crm\Volume\IVolumeUrl
{
	/** @var array */
	...
	public function measureEntity()
	{
		...
		if ($this->prepareFilter($query))
		{
			...
			$query
				...
				->registerRuntimeField('', new Entity\ExpressionField('ENTITY_SIZE', 'COUNT(%s) * '.$avgLeadTableRowLength, 'ID'))
