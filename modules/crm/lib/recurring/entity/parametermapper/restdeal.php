...
class RestDeal extends DealMap
{
	...
	const FIELD_SINGLE_INTERVAL_NAME = 'BEFORE_START_DATE_VALUE';
	const FIELD_SINGLE_TYPE_NAME = 'BEFORE_START_DATE_TYPE';
	const FIELD_MULTIPLE_CUSTOM_TYPE_NAME = 'TYPE';
	const FIELD_MULTIPLE_CUSTOM_INTERVAL_NAME = 'INTERVAL';
