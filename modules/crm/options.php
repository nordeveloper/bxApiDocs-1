...
if($MOD_RIGHT>='R'):
	...
	$arOptionsPath = array(
		...
		array('path_to_lead_calendar', GetMessage('CRM_OPTIONS_PATH_TO_LEAD_CALENDAR'), '/crm/lead/calendar/', Array('text', '40')),
		...
		array('path_to_deal_calendar', GetMessage('CRM_OPTIONS_PATH_TO_DEAL_CALENDAR'), '/crm/deal/calendar/', Array('text', '40')),
